...
export default function Home() {
  ...
  return (
    <div className="bg-[url('/backgroun.jpg')] bg-cover bg-center bg-repeat overflow-hidden">
      ...
      {/* WHO AM I SECTION */}
      <section id="about" className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-24 flex flex-col lg:flex-row w-full items-start top-[5rem] sm:top-[8rem] lg:top-[10rem] scale-80">
        {/* Left Stack */}
      ...
      <div className="flex-row justify-center align-center items-start scale-100 sm:scale-125 lg:scale-80 px-4 sm:px-6 lg:px-8">
        <Image
      ...
      {/* MY WORK SECTION */}
      <section id="work" className="relative flex-column justify-center w-full max-w-2xl py-16 sm:py-24 lg:py-35 mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div>
          <Image
          ...
          <div className="relative flex flex-col items-center lg:items-start">
            ...
            <motion.div className="flex justify-center lg:justify-right scale-100 sm:scale-125 lg:scale-150 lg:left-[-5rem]">
              <Image
                ...
                width={500}
                height={700}
                className="relative object-contain z-4 right-0 lg:right-[-10rem] top-0 lg:top-[-1rem] 2xl:scale-70 2xl:top-[rem] left-[-1rem]"
              />
            </motion.div>
            ...
            <motion.div className="flex justify-center lg:justify-right scale-100 sm:scale-125 lg:scale-100">
              <Image
                ...
                width={500}
                height={700}
                className="relative object-contain w-full max-w-xs z-4 right-0 lg:right-[-1rem] 2xl:scale-100  2xl:top-[rem] 2xl:left-[13rem] lg:top-[rem]"
              />
            </motion.div>
          </div>
        </div>                                        
